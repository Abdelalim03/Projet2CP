...
export default function CustomCard(props) {
  return (
    <div className="flex flex-col gap-3">
      ...
      <div className={`container flex ${props.bgcolor} lg:rounded-[40px] md:rounded-[30px] lg:h-[210px] md:h-36 lg:w-[490px] md:w-[340px] items-center justify-between  `}>
        <div className="flex flex-col justify-evenly items-center lg:ml-10 md:ml-5 lg:gap-2 md:gap-1">
          <h1 className="text-white font-bold lg:text-3xl md:text-2xl ">{props.mainContent}</h1>
