...
function ExercicesAr({Max}) {
  ...
  let tableOfex=[
  {class:"lg:top-[110px] top-[80px] right-0",stars:4,id:1},
  ...
  {class:" lg:right-[216px] lg:top-[434px] right-[156px] top-[314px]",stars:1,id:6},       
  {class:" lg:right-[216px] lg:top-[326px] right-[156px] top-[236px]",stars:1,id:7},         
  {class:" lg:right-[216px] lg:top-[218px] right-[156px] top-[158px]",stars:1,id:8},     
  {class:" lg:right-[216px] lg:top-[110px] right-[156px] top-[80px]",stars:1,id:9 },     
  {class:" lg:right-[216px] lg:top-1 right-[156px] top-[2px]",stars:1,id:10 },
  {class:" lg:right-[324px] lg:top-1 right-[234px] top-[2px]",stars:1,id:11  },
  {class:" lg:right-[432px] lg:top-1 right-[312px] top-[2px]",stars:1,id:12  },
  {class:" lg:right-[540px] lg:top-1 right-[390px] top-[2px]",stars:1,id:13},
  {class:" lg:right-[648px] lg:top-1 right-[468px] top-[2px]",stars:1,id:14   },
  {class:" lg:right-[756px] lg:top-1 right-[546px] top-[2px]",stars:1,id:15 },  
  {class:" lg:right-[756px] lg:top-[110px] right-[546px] top-[80px]",stars:1,id:16  },
  {class:" lg:right-[756px] lg:top-[218px] right-[546px] top-[158px]",stars:1,id:17 },     
  {class:" lg:right-[648px] lg:top-[218px] right-[468px] top-[158px]",stars:1,id:18}, 
  {class:" lg:right-[540px] lg:top-[218px] right-[390px] top-[158px]" ,stars:1,id:19  },
  {class:" lg:right-[432px] lg:top-[218px] right-[312px] top-[158px]",stars:1,id:20   },
  {class:" lg:right-[432px] lg:top-[326px] right-[312px] top-[236px]",stars:1,id:21 },
  {class:" lg:right-[432px] lg:top-[434px] right-[312px] top-[314px]",stars:1,id:22},
  {class:" lg:right-[540px] lg:top-[434px] right-[390px] top-[314px]",stars:1,id:23},
  {class:" lg:right-[648px] lg:top-[434px] right-[468px] top-[314px]",stars:1,id:24},
