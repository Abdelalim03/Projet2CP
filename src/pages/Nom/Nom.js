    ...
    <div className="relative w-screen h-screen ">
        ...
        <div className='flex justify-center'>
            <div className="relative flex  justify-center items-center lg:-mt-4 h-52 lg:h-72 w-[55%] lg:w-[43%] bg-[url('./grid.png')] bg-[#80aaff12] border-solid border-4 border-[#0083CB] rounded-3xl ">
                ...
                <div className='flex  h-[50px] lg:h-16 pl-7 rounded-2xl w-[75%]'>
                <input type="text" className='rounded-l-2xl h-full m-0  pl-8 lg:pl-9 pr-2 text-base lg:text-xl w-[63%] focus:outline-none' placeholder="Nom d'utilisateur" />
