...
function InsPolygoneContent() {
  return (
    <div className='insPolygoneContent h-40 w-28 pl-4 hidden absolute left-[50px] lg:left-[60px] -bottom-[120%] lg:-bottom-[70%]'>
        <div className='z-10 w-20 lg:w-24 h-32 lg:h-40 px-1 border-2 flex flex-col justify-around border-[#6A5CF7] bg-[#FFDFD9]'>
                ...
                <div className='flex flex-row justify-around'>
                    ...
                    <input className='h-4 lg:h-5 w-8 lg:w-10 px-1 lg:px-2 text-sm lg:text-base font-semibold text-[#283D93]' type="number" id="b" min="6" max="8" placeholder="6"/>
                </div>
        </div>
    </div>
  )
