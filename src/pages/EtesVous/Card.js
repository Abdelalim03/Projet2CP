...
export default function Card({ path, scale, name }) {
  return (
    <div class="group transform hover:scale-105 transition ease-out cursor-pointer">
    <div class="inline-flex h-64 w-48 lg:h-72 lg:w-52">
        <div class="flex flex-1 h-full group-hover:rotate-0 -rotate-3 transform rounded-2xl bg-[#C7DBFE] hover:bg-[#7EABFF] p-5">
