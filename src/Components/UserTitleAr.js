...
export default function UserTitleAr(props) {
  return (
    <div className="flex flex-row-reverse items-center lg:gap-2 gap-1 ">
        ...
        <p dir='rtl' className="lg:text-2xl font-['Tajawal'] md:text-base font-bold"> {props.message} {props.userName} !</p>
    </div>
  )
}
